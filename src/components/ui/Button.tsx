      ...
      <button
        className={clsx(
          'inline-flex items-center justify-center rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
          {
            ...
            'bg-secondary-500 text-white hover:bg-secondary-600 focus:ring-secondary-400': variant === 'secondary',
            'bg-accent-500 text-white hover:bg-accent-600 focus:ring-accent-400': variant === 'accent',
