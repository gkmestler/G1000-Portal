...
import { transformProject, formatDateForInput, getTodayDate } from '@/lib/utils';
  ...
  const fetchProject = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Populate form with existing data and auto-enable optional fields that have values
        ...
        setShowOptionalFields({
          duration: hasDuration || false,
          hours: hasHours || false,
          compensation: hasCompensation || false,
          budget: hasBudget || false,
          skills: hasSkills || false,
          deliverables: hasDeliverables || false,
        ...
        setFormData({
          ...
          estimatedDuration: (projectData as any).duration || (projectData as any).estimatedDuration || '',
          estimatedHoursPerWeek: (projectData as any).estimatedHoursPerWeek || '',
          compensationType: projectData.compensationType || 'experience',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Update your opportunity for talented G1000 students</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    Be careful when editing opportunity details as it may affect existing applicants.
                    ...
                    {PROJECT_TYPES.map((type) => (
                      ...
                      >
                        <CheckCircleIcon className={`w-5 h-5 mx-auto mb-1 ${
                          formData.type === type ? 'text-green-600' : 'text-gray-400'
                        }`} />
                        ...
                        {LOCATION_OPTIONS.map((loc) => (
                          ...
                          >
                            <MapPinIcon className={`w-5 h-5 mx-auto mb-1 ${
                              formData.location === loc ? 'text-green-600' : 'text-gray-400'
                            }`} />
                            {loc}
                          </button>
                        ))}
